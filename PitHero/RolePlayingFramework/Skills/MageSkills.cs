...
namespace RolePlayingFramework.Skills
{
    ...
    {
        public FireSkill() : base("mage.fire", "Fire", SkillKind.Active, SkillTargetType.SingleEnemy, 2, 3) { }
    ...
    {
        public FireStormSkill() : base("mage.firestorm", "FireStorm", SkillKind.Active, SkillTargetType.SurroundingEnemies, 3, 6) { }
        public override string Execute(Hero hero, IEnemy primary, List<IEnemy> surrounding, IAttackResolver resolver)
        {
            var stats = hero.GetTotalStats();
    ...
    {
        public HeartOfFirePassive() : base("mage.heart_fire", "Heart of Fire", SkillKind.Passive, SkillTargetType.Self, 1, 0) { }
    ...
    {
        public EconomistPassive() : base("mage.economist", "Economist", SkillKind.Passive, SkillTargetType.Self, 2, 0) { }
        public override void ApplyPassive(Hero hero)
        {
