...
namespace RolePlayingFramework.Skills
{
    ...
    {
        public HealSkill() : base("priest.heal", "Heal", SkillKind.Active, SkillTargetType.Self, 3, 100) { }
    ...
    {
        public DefenseUpSkill() : base("priest.defup", "Defense Up", SkillKind.Active, SkillTargetType.Self, 4, 160) { }
        public override string Execute(Hero hero, IEnemy primary, List<IEnemy> surrounding, IAttackResolver resolver)
        {
    ...
    {
        public MenderPassive() : base("priest.mender", "Mender", SkillKind.Passive, SkillTargetType.Self, 0, 80) { }
        public override void ApplyPassive(Hero hero)
        {
