...
namespace RolePlayingFramework.Skills
{
    ...
    {
        public ArcaneFocusPassive() : base("spellsniper.arcane_focus", "Arcane Focus", SkillKind.Passive, SkillTargetType.Self, 0, 180) { }
    ...
    {
        public SpellPrecisionPassive() : base("spellsniper.spell_precision", "Spell Precision", SkillKind.Passive, SkillTargetType.Self, 0, 220) { }
        public override void ApplyPassive(Hero hero)
        {
    ...
    {
        public MeteorArrowSkill() : base("spellsniper.meteor_arrow", "Meteor Arrow", SkillKind.Active, SkillTargetType.SingleEnemy, 7, 250) { }
    ...
    {
        public ElementalStormSkill() : base("spellsniper.elemental_storm", "Elemental Storm", SkillKind.Active, SkillTargetType.SurroundingEnemies, 10, 220) { }
        public override string Execute(Hero hero, IEnemy primary, List<IEnemy> surrounding, IAttackResolver resolver)
        {
            var stats = hero.GetTotalStats();
