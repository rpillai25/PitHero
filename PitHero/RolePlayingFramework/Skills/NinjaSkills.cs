...
namespace RolePlayingFramework.Skills
{
    ...
    {
        public EvasionMasteryPassive() : base("ninja.evasion_mastery", "Evasion Mastery", SkillKind.Passive, SkillTargetType.Self, 1, 0, 120) { }
    ...
    {
        public TrapMasterPassive() : base("ninja.trap_master", "Trap Master", SkillKind.Passive, SkillTargetType.Self, 2, 0, 160) { }
        public override void ApplyPassive(Hero hero)
        {
    ...
    {
        public ShadowSlashSkill() : base("ninja.shadow_slash", "Shadow Slash", SkillKind.Active, SkillTargetType.SingleEnemy, 2, 4, 200) { }
    ...
    {
        public SmokeBombSkill() : base("ninja.smoke_bomb", "Smoke Bomb", SkillKind.Active, SkillTargetType.Self, 3, 6, 220) { }
        public override string Execute(Hero hero, IEnemy primary, List<IEnemy> surrounding, IAttackResolver resolver)
        {
