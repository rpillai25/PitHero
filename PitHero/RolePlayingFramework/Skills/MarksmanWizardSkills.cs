...
namespace RolePlayingFramework.Skills
{
    ...
    {
        public EagleFocusPassive() : base("marksmanwizard.eagle_focus", "Eagle Focus", SkillKind.Passive, SkillTargetType.Self, 1, 0, 180) { }
    ...
    {
        public QuickcastVolleyPassive() : base("marksmanwizard.quickcast_volley", "Quickcast Volley", SkillKind.Passive, SkillTargetType.Self, 2, 0, 220) { }
        public override void ApplyPassive(Hero hero)
        {
    ...
    {
        public MeteorShotSkill() : base("marksmanwizard.meteor_shot", "Meteor Shot", SkillKind.Active, SkillTargetType.SingleEnemy, 2, 7, 250) { }
    ...
    {
        public PurifyingArrowSkill() : base("marksmanwizard.purifying_arrow", "Purifying Arrow", SkillKind.Active, SkillTargetType.Self, 3, 6, 220) { }
        public override string Execute(Hero hero, IEnemy primary, List<IEnemy> surrounding, IAttackResolver resolver)
        {
