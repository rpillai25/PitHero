...
namespace RolePlayingFramework.Skills
{
    ...
    {
        public DivineVeilPassive() : base("holyshadow.divine_veil", "Divine Veil", SkillKind.Passive, SkillTargetType.Self, 1, 0, 180) { }
    ...
    {
        public LightAndDarkPassive() : base("holyshadow.light_and_dark", "Light and Dark", SkillKind.Passive, SkillTargetType.Self, 2, 0, 220) { }
        public override void ApplyPassive(Hero hero)
        {
    ...
    {
        public ShadowShotSkill() : base("holyshadow.shadow_shot", "Shadow Shot", SkillKind.Active, SkillTargetType.SingleEnemy, 2, 5, 250) { }
    ...
    {
        public SacredSilenceSkill() : base("holyshadow.sacred_silence", "Sacred Silence", SkillKind.Active, SkillTargetType.SurroundingEnemies, 3, 8, 220) { }
        public override string Execute(Hero hero, IEnemy primary, List<IEnemy> surrounding, IAttackResolver resolver)
        {
            var stats = hero.GetTotalStats();
