...
namespace RolePlayingFramework.Skills
{
    ...
    {
        public SpiritGuardPassive() : base("divinefist.spirit_guard", "Spirit Guard", SkillKind.Passive, SkillTargetType.Self, 0, 120, ElementType.Neutral) { }
    ...
    {
        public EnlightenedPassive() : base("divinefist.enlightened", "Enlightened", SkillKind.Passive, SkillTargetType.Self, 0, 160, ElementType.Neutral) { }
        public override void ApplyPassive(Hero hero)
        {
    ...
    {
        public SacredStrikeSkill() : base("divinefist.sacred_strike", "Sacred Strike", SkillKind.Active, SkillTargetType.SingleEnemy, 4, 200, ElementType.Light) { }
    ...
    {
        public AuraShieldSkill() : base("divinefist.aura_shield", "Aura Shield", SkillKind.Active, SkillTargetType.Self, 7, 220, ElementType.Light) { }
        public override string Execute(Hero hero, IEnemy primary, List<IEnemy> surrounding, IAttackResolver resolver)
        {
