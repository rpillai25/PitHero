...
namespace RolePlayingFramework.Skills
{
    ...
    {
        public SoulMendPassive() : base("soulguardian.soul_mend", "Soul Mend", SkillKind.Passive, SkillTargetType.Self, 1, 0, 180) { }
    ...
    {
        public BlessingShadowsPassive() : base("soulguardian.blessing_shadows", "Blessing of Shadows", SkillKind.Passive, SkillTargetType.Self, 2, 0, 220) { }
        public override void ApplyPassive(Hero hero)
        {
    ...
    {
        public SpiritLeechSkill() : base("soulguardian.spirit_leech", "Spirit Leech", SkillKind.Active, SkillTargetType.SingleEnemy, 2, 6, 250) { }
    ...
    {
        public GuardianVeilSkill() : base("soulguardian.guardian_veil", "Guardian Veil", SkillKind.Active, SkillTargetType.Self, 3, 8, 220) { }
        public override string Execute(Hero hero, IEnemy primary, List<IEnemy> surrounding, IAttackResolver resolver)
        {
