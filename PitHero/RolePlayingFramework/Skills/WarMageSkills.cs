...
namespace RolePlayingFramework.Skills
{
    ...
    {
        public FocusedMindPassive() : base("warmage.focused_mind", "Focused Mind", SkillKind.Passive, SkillTargetType.Self, 0, 100, ElementType.Neutral) { }
    ...
    {
        public ArcaneDefensePassive() : base("warmage.arcane_defense", "Arcane Defense", SkillKind.Passive, SkillTargetType.Self, 0, 140, ElementType.Neutral) { }
        public override void ApplyPassive(Hero hero)
        {
    ...
    {
        public SpellbladeSkill() : base("warmage.spellblade", "Spellblade", SkillKind.Active, SkillTargetType.SingleEnemy, 6, 180, ElementType.Fire) { }
    ...
    {
        public BlitzSkill() : base("warmage.blitz", "Blitz", SkillKind.Active, SkillTargetType.SurroundingEnemies, 8, 220, ElementType.Wind) { }
        public override string Execute(Hero hero, IEnemy primary, List<IEnemy> surrounding, IAttackResolver resolver)
        {
            var stats = hero.GetTotalStats();
