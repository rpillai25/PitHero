...
namespace RolePlayingFramework.Skills
{
    ...
    {
        public EagleReflexesPassive() : base("marksman.eagle_reflexes", "Eagle Reflexes", SkillKind.Passive, SkillTargetType.Self, 0, 110, ElementType.Neutral) { }
    ...
    {
        public SteadyAimPassive() : base("marksman.steady_aim", "Steady Aim", SkillKind.Passive, SkillTargetType.Self, 0, 150, ElementType.Neutral) { }
        public override void ApplyPassive(Hero hero)
        {
    ...
    {
        public PowerVolleySkill() : base("marksman.power_volley", "Power Volley", SkillKind.Active, SkillTargetType.SurroundingEnemies, 8, 190, ElementType.Neutral) { }
    ...
    {
        public ArmorPiercerSkill() : base("marksman.armor_piercer", "Armor Piercer", SkillKind.Active, SkillTargetType.SingleEnemy, 5, 210, ElementType.Neutral) { }
        public override string Execute(Hero hero, IEnemy primary, List<IEnemy> surrounding, IAttackResolver resolver)
        {
            var stats = hero.GetTotalStats();
