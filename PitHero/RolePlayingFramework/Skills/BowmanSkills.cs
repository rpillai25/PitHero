...
namespace RolePlayingFramework.Skills
{
    ...
    {
        public PowerShotSkill() : base("bowman.power_shot", "Power Shot", SkillKind.Active, SkillTargetType.SingleEnemy, 4, 130, ElementType.Neutral) { }
    ...
    {
        public VolleySkill() : base("bowman.volley", "Volley", SkillKind.Active, SkillTargetType.SurroundingEnemies, 7, 200, ElementType.Neutral) { }
        public override string Execute(Hero hero, IEnemy primary, List<IEnemy> surrounding, IAttackResolver resolver)
        {
            var stats = hero.GetTotalStats();
    ...
    {
        public EagleEyePassive() : base("bowman.eagle_eye", "Eagle Eye", SkillKind.Passive, SkillTargetType.Self, 0, 70, ElementType.Neutral) { }
    ...
    {
        public QuickdrawPassive() : base("bowman.quickdraw", "Quickdraw", SkillKind.Passive, SkillTargetType.Self, 0, 100, ElementType.Neutral) { }
        public override void ApplyPassive(Hero hero)
        {
