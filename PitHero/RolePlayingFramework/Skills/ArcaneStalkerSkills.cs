...
namespace RolePlayingFramework.Skills
{
    ...
    {
        public TrackersArcanaPassive() : base("arcanestalker.trackers_arcana", "Tracker's Arcana", SkillKind.Passive, SkillTargetType.Self, 1, 0, 180) { }
    ...
    {
        public QuickArcaneEscapePassive() : base("arcanestalker.quick_arcane_escape", "Quick Arcane Escape", SkillKind.Passive, SkillTargetType.Self, 2, 0, 220) { }
        public override void ApplyPassive(Hero hero)
        {
    ...
    {
        public PiercingVenomSkill() : base("arcanestalker.piercing_venom", "Piercing Venom", SkillKind.Active, SkillTargetType.SingleEnemy, 2, 7, 250) { }
    ...
    {
        public ArcaneVolleySkill() : base("arcanestalker.arcane_volley", "Arcane Volley", SkillKind.Active, SkillTargetType.SurroundingEnemies, 3, 8, 220) { }
        public override string Execute(Hero hero, IEnemy primary, List<IEnemy> surrounding, IAttackResolver resolver)
        {
            var stats = hero.GetTotalStats();
