...
namespace RolePlayingFramework.Skills
{
    ...
    {
        public DragonSightPassive() : base("dragonmarksman.dragon_sight", "Dragon Sight", SkillKind.Passive, SkillTargetType.Self, 1, 0, 180) { }
    ...
    {
        public KiVolleyPassive() : base("dragonmarksman.ki_volley", "Ki Volley", SkillKind.Passive, SkillTargetType.Self, 2, 0, 220) { }
        public override void ApplyPassive(Hero hero)
        {
    ...
    {
        public DragonArrowSkill() : base("dragonmarksman.dragon_arrow", "Dragon Arrow", SkillKind.Active, SkillTargetType.SingleEnemy, 2, 7, 250) { }
    ...
    {
        public EnergyShotSkill() : base("dragonmarksman.energy_shot", "Energy Shot", SkillKind.Active, SkillTargetType.SurroundingEnemies, 3, 8, 220) { }
        public override string Execute(Hero hero, IEnemy primary, List<IEnemy> surrounding, IAttackResolver resolver)
        {
            var stats = hero.GetTotalStats();
            // Multi-hit AoE
