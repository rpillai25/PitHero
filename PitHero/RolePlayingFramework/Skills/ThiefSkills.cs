...
namespace RolePlayingFramework.Skills
{
    ...
    {
        public SneakAttackSkill() : base("thief.sneak_attack", "Sneak Attack", SkillKind.Active, SkillTargetType.SingleEnemy, 2, 3, 130) { }
    ...
    {
        public VanishSkill() : base("thief.vanish", "Vanish", SkillKind.Active, SkillTargetType.Self, 3, 6, 180) { }
        public override string Execute(Hero hero, IEnemy primary, List<IEnemy> surrounding, IAttackResolver resolver)
        {
    ...
    {
        public ShadowstepPassive() : base("thief.shadowstep", "Shadowstep", SkillKind.Passive, SkillTargetType.Self, 1, 0, 70) { }
    ...
    {
        public TrapSensePassive() : base("thief.trap_sense", "Trap Sense", SkillKind.Passive, SkillTargetType.Self, 2, 0, 90) { }
        public override void ApplyPassive(Hero hero)
        {
