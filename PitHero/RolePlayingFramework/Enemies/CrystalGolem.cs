...
{
    /// <summary>Hulking crystalline construct with faceted limbs.</summary>
    public sealed class CrystalGolem : IEnemy
    {
        private int _hp;

        public string Name => MonsterTextKey.Monster_CrystalGolem;
        public EnemyId EnemyId => EnemyId.CrystalGolem;
        ...
        public float JoinPercentageModifier => 0.15f;

        public CrystalGolem(int level = 12)
        {
            var presetLevel = PitHero.Config.EnemyLevelConfig.GetPresetLevel(EnemyId.CrystalGolem);
            ...
            // Crystal Golem is Earth element: resistant to Earth, weak to Wind
