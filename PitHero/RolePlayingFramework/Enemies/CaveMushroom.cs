...
{
    /// <summary>Ambulatory fungus with toxic spores.</summary>
    public sealed class CaveMushroom : IEnemy
    {
        private int _hp;
        ...
        public CaveMushroom(int level = 2)
        {
            ...
            // Cave Mushroom is Earth element: resistant to Earth, weak to Wind
