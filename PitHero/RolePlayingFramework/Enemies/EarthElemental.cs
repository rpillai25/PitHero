...
{
    /// <summary>Living embodiment of stone and earth. Mid-game boss of the Cave Biome.</summary>
    public sealed class EarthElemental : IEnemy
    {
        private int _hp;
        ...
        public EarthElemental(int level = 17)
        {
            ...
            // Earth Elemental is Earth element: resistant to Earth, weak to Wind
