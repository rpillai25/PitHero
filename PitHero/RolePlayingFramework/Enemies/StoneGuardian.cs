...
{
    /// <summary>Animated stone statue guarding ancient cave passages. First boss of the Cave Biome.</summary>
    public sealed class StoneGuardian : IEnemy
    {
        private int _hp;

        public string Name => MonsterTextKey.Monster_StoneGuardian;
        public EnemyId EnemyId => EnemyId.StoneGuardian;
        ...
        {
            var presetLevel = PitHero.Config.EnemyLevelConfig.GetPresetLevel(EnemyId.StoneGuardian);
            ...
            // Stone Guardian is Earth element: resistant to Earth, weak to Wind
