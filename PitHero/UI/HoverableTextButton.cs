...
namespace PitHero.UI
{
    ...
    public class HoverableTextButton : TextButton
    {
        ...
        {
            // Self-hiding: the window watches this button's hierarchy, since Draw below never
        ...
        {
            // Nez only clears _mouseOver on a mouse-exit event, which never fires for a button
