namespace PitHero.Services.Replay
{
    ...
    /// seed (and later the recording) here before swapping scenes, and MainGameScene.Begin consumes it
    /// before generating any world content. Mirrors the SaveLoadService.PendingLoadData pattern.
    /// </summary>
    public sealed class ReplaySessionBootstrap
    {
        ...
        /// <summary>Creates a bootstrap for the given seed.</summary>
        public ReplaySessionBootstrap(int masterSeed)
        {
