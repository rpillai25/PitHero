...
namespace PitHero.Tests
{
    ...
    public class JumpIntoPitActionTests
    {
        ...
        public void GoapConstants_SimplifiedModel_ShouldOnlyContainCoreConstants()
        {
            ...
            // 16 hero states + 4 mercenary states + 2 crystal states + 1 time-of-day state + 2 stop-adventuring states
            // + 10 hero actions + 4 mercenary actions + 1 crystal action + 2 stop-adventuring actions
            Assert.AreEqual(42, fields.Count(), "Should have exactly 42 GOAP constants (16 hero states + 4 mercenary states + 2 crystal states + 1 time-of-day state + 2 stop-adventuring states + 10 hero actions + 4 mercenary actions + 1 crystal action + 2 stop-adventuring actions)");
        }
